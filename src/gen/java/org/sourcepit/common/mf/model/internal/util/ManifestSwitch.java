   ...
   protected T doSwitch(int classifierID, EObject theEObject)
   {
      switch (classifierID)
      {
         case ManifestPackage.MANIFEST:
         {
            ...
            if (result == null) result = caseAbstractEntriesContainer(manifest);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
         case ManifestPackage.EMAP_ENTRY:
         {
            @SuppressWarnings("unchecked") Map.Entry<?, ?> eMapEntry = (Map.Entry<?, ?>)theEObject;
         ...
         case ManifestPackage.SECTION:
         {
            ...
            if (result == null) result = caseAbstractEntriesContainer(section);
            if (result == null) result = defaultCase(theEObject);
            return result;
         }
