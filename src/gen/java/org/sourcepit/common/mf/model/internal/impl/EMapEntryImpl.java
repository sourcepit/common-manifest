...
public class EMapEntryImpl<K, V> extends EObjectImpl implements BasicEMap.Entry<K, V>
{
   ...
   {
      return ManifestPackage.Literals.EMAP_ENTRY;
   }
   ...
   public void setTypedKey(K newKey)
   {
      ...
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, ManifestPackage.EMAP_ENTRY__KEY, oldKey, key));
   }
   ...
   public void setTypedValue(V newValue)
   {
      ...
      value = newValue;
      if (eNotificationRequired())
         eNotify(new ENotificationImpl(this, Notification.SET, ManifestPackage.EMAP_ENTRY__VALUE, oldValue, value));
   }
