...
public class ManifestAdapterFactory extends AdapterFactoryImpl
{
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.common.mf.internal.model.Manifest
    * <em>Manifest</em>}'. <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.common.mf.internal.model.Section
