...
public class ManifestAdapterFactory extends AdapterFactoryImpl
{
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.common.mf.internal.model.Manifest <em>Manifest</em>}'.
   ...
   /**
    * Creates a new adapter for an object of class '{@link org.sourcepit.common.mf.internal.model.Section <em>Section</em>}'.
    * <!-- begin-user-doc --> This default implementation returns null so that we can easily ignore
    * cases; it's useful to ignore a case when inheritance will catch all the cases anyway. <!-- end-user-doc -->
    * @return the new adapter.
